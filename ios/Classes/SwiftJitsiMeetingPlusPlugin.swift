...
public class SwiftJitsiMeetingPlusPlugin: NSObject, FlutterPlugin, FlutterStreamHandler {
    var window: UIWindow?
    ...
    public static func register(with registrar: FlutterPluginRegistrar) {
        ...
        let instance = SwiftJitsiMeetingPlusPlugin(uiViewController: viewController)

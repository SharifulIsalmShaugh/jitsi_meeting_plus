...
class FeatureFlag {
  ...
  bool? androidAudioFocusDisabled; // new
  bool? audioMuteEnabled; // new
  bool? filmstripEnabled; // new
  bool? helpEnabled; // new
  bool? notificationsEnabled; // new
  bool? overflowMenuEnabled; // new
  bool? toolboxEnabled; // new
  bool? videoMuteEnabled; // new
  ...
  Map<String?, dynamic> allFeatureFlags() {
    ...
    if (androidAudioFocusDisabled != null)
      featureFlags[FeatureFlagHelper
              .featureFlags[FeatureFlagEnum.ANDROID_AUDIO_FOCUS_DISABLED]] =
          androidAudioFocusDisabled;
    ...
    if (helpEnabled != null)
      featureFlags[FeatureFlagHelper
          .featureFlags[FeatureFlagEnum.HELP_BUTTON_ENABLED]] = helpEnabled;
